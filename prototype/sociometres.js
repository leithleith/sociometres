document.addEventListener('DOMContentLoaded', function() {
	...
	const accueilLink = document.querySelector('a[data-target="accueil"]');
	...
	const links = document.querySelectorAll('.sous-menu a');
	links.forEach(link => {
		link.addEventListener('click', function(e) {
			...
			document.querySelectorAll('.menu-principal > li').forEach(li => {
				li.classList.remove('active');
			});
		});
	});
	const parentLinks = document.querySelectorAll('.menu-principal > li > a:not([data-target])');
...
function melanger(numero)
{
    ...
    switch (numero)
    {
        case 0:
			...
			if (!document.getElementById("questencadr").innerHTML.includes("input"))
			{
        ...
        case 1:
			...
			if (!document.getElementById("questviolent").innerHTML.includes("input"))
			{
        ...
        case 2:
			...
			if (!document.getElementById("questrps").innerHTML.includes("input"))
			{
    ...
    {
        document.getElementById("quest" + suffixe).innerHTML += tableau[n];
    }
    document.getElementById("quest" + suffixe).innerHTML += '<hr/><button onclick="calcul(' + numero + ')">Calculer</button>';
}
    ...
    switch (numero)
    {
        case 0:
            ...
            if (A+B+C != 0)
            {
                ...
                document.getElementById("questencadr").innerHTML = restitution;
        ...
        case 1:
            ...
            if (A+B+C+D+E != 0)
            {
                ...
                document.getElementById("questviolent").innerHTML = restitution;
                for (var i=0;i<coches.length;i++)
                {      
					if (coches[i] == true)
					{
        ...
        case 2:
            ...
            if (A+B+C != 0)
            {
                ...
                document.getElementById("questrps").innerHTML = restitution;
                for (var i=0;i<coches.length;i++)
                {      
					if (coches[i] == true)
					{
